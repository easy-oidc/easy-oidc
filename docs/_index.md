...
- [Getting Started](/docs/getting-started/) - Try Truster locally or choose a deployment target
- [Why Truster?](/docs/why-truster/) - Decide whether its scope fits your team
- [OIDC Primer](/docs/oidc-primer/) - Learn how OAuth2 and OIDC work with Truster
